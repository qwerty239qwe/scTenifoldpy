...
def build_xct(
    ...
    """Run scTenifoldXct single-sample cell-cell interaction analysis."""
    from scTenifold.xct.core import main
...
def build_xct_merge(
    ...
    """Run scTenifoldXct two-sample differential interaction analysis."""
    from scTenifold.xct.merge import main
